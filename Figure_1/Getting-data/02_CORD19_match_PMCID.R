...
filename <- "output/CORD19id_date.csv"
...
#3780 records without (proper) date
#3225 with PMCID
...
# NB this gives a message for each result - find a way to suppress them

#extract data and format date
pmcid_date <- extractData(pmcid_date)

#3141 records retrieved from EuropePMC

filename2 <- "data/pmcid_date.csv"
...
filename3 <- "output/CORD19id_date.csv"
# write to csv
